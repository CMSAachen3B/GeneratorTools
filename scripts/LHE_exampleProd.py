...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    args = cms.vstring('/.automount/net_rw/net__scratch_cms3b/hsert/pool/analysis/GeneratorTools/lfv/CMSSW_7_1_20_patch2/src/CMSAachen3B/GeneratorTools/scripts/ppTOzTOleplfv_tarball.tar.xz')
)
...
# End of customisation functionss
