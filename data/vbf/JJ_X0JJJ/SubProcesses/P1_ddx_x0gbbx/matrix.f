...
C     
C     Process: d d~ > x0 g b b~ QCD<=1 QED<=99 QNP=0 @1
C     Process: s s~ > x0 g b b~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_7,MDL_MB,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,10))
