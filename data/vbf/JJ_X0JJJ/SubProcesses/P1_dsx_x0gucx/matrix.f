...
C     
C     Process: d s~ > x0 g u c~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV3_3(W(1,1),W(1,9),GC_73,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,7),W(1,10),W(1,3),GC_99,AMP(2))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV3_3(W(1,6),W(1,10),GC_110,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,2),W(1,8),W(1,3),GC_99,AMP(3))
      CALL FFV1_2(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,2))
      CALL FFV3_3(W(1,2),W(1,5),GC_73,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,7),W(1,4),W(1,3),GC_99,AMP(4))
      JAMP(1)=+AMP(2)+AMP(4)
      JAMP(2)=+AMP(1)+AMP(3)
