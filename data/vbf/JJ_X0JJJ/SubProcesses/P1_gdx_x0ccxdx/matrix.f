...
C     
C     Process: g d~ > x0 c c~ d~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,6),W(1,4),GC_75,MDL_MW,MDL_WW,W(1,8))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV3_6_3(W(1,5),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV3_3(W(1,10),W(1,4),GC_75,MDL_MW,MDL_WW,W(1,6))
