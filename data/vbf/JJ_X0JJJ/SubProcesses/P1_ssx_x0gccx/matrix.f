...
C     
C     Process: s s~ > x0 g c c~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,1),W(1,5),GC_76,MDL_MW,MDL_WW,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_3(W(1,6),W(1,2),GC_110,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV3_4_3(W(1,10),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,9),W(1,4),W(1,3),GC_100,AMP(7))
      CALL FFV3_3(W(1,10),W(1,5),GC_76,MDL_MW,MDL_WW,W(1,4))
