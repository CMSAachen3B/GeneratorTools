...
C     
C     Process: g d > x0 d b b~ QCD<=1 QED<=99 QNP=0 @1
C     Process: g s > x0 s b b~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_1,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV3_4_0(W(1,7),W(1,5),W(1,10),GC_77,GC_89,AMP(4))
      CALL FFV3_4_3(W(1,6),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,9),W(1,10),W(1,3),GC_100,AMP(5))
      CALL FFV1_1(W(1,4),W(1,1),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,2),W(1,10),GC_1,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,8),W(1,11),GC_1,AMP(6))
      CALL FFV3_4_3(W(1,2),W(1,10),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV3_4_0(W(1,6),W(1,8),W(1,12),GC_77,GC_89,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,7),W(1,5),W(1,11),GC_1,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV3_4_0(W(1,7),W(1,5),W(1,12),GC_77,GC_89,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVS4_0(W(1,9),W(1,12),W(1,3),GC_100,AMP(10))
      CALL FFV1_1(W(1,5),W(1,1),GC_7,MDL_MB,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,9))
      CALL FFS1_2_1(W(1,12),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,6),W(1,11),W(1,9),GC_1,AMP(11))
      CALL FFV3_4_3(W(1,2),W(1,4),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,6),W(1,1),GC_7,MDL_MB,ZERO,W(1,12))
      CALL FFS1_2_2(W(1,12),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,11))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,11),W(1,5),W(1,9),GC_1,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV3_4_0(W(1,11),W(1,5),W(1,10),GC_77,GC_89,AMP(17))
      CALL FFV3_4_3(W(1,12),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,11))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,5),W(1,9),GC_1,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV3_4_0(W(1,12),W(1,5),W(1,10),GC_77,GC_89,AMP(24))
