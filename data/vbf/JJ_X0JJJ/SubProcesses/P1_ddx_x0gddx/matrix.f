...
C     ----------
      ...
      CALL FFV3_4_3(W(1,6),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,8))
      CALL FFV3_4_3(W(1,7),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_4_3(W(1,1),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,7))
      CALL FFV3_4_3(W(1,6),W(1,10),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,7),W(1,11),W(1,3),GC_100,AMP(3))
      CALL FFV3_4_3(W(1,1),W(1,10),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,9),W(1,11),W(1,3),GC_100,AMP(4))
      CALL FFV1_1(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV3_4_3(W(1,1),W(1,11),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL VVS4_0(W(1,8),W(1,10),W(1,3),GC_100,AMP(6))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV3_4_3(W(1,10),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,6))
