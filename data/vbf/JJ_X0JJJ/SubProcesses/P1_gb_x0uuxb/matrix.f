...
C     
C     Process: g b > x0 u u~ b QCD<=1 QED<=99 QNP=0 @1
C     Process: g b > x0 c c~ b QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,7),W(1,4),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,8),W(1,9),GC_1,AMP(1))
      CALL FFV3_6_3(W(1,7),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV3_6_3(W(1,5),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,10))
