...
C     
C     Process: d~ b > x0 g d~ b QCD<=1 QED<=99 QNP=0 @1
C     Process: s~ b > x0 g s~ b QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV3_4_3(W(1,7),W(1,1),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,2),W(1,4),GC_7,MDL_MB,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 24
      ...
      JAMP(1)=+AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)+AMP(16)+AMP(17)
