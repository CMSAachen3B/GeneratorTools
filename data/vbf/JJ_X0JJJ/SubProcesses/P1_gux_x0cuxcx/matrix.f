...
C     
C     Process: g u~ > x0 c u~ c~ QCD<=1 QED<=99 QNP=0 @1
C     Process: g c~ > x0 u c~ u~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_6_3(W(1,5),W(1,2),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV3_6_3(W(1,5),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,6))
