...
C     
C     Process: s s~ > x0 g u u~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,1),W(1,5),GC_74,MDL_MW,MDL_WW,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_3(W(1,6),W(1,2),GC_108,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV3_3(W(1,10),W(1,5),GC_74,MDL_MW,MDL_WW,W(1,4))
