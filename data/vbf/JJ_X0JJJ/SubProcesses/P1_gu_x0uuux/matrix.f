...
C     
C     Process: g u > x0 u u u~ QCD<=1 QED<=99 QNP=0 @1
C     Process: g c > x0 c c c~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_6_3(W(1,6),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_6_3(W(1,2),W(1,5),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV3_6_3(W(1,2),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV3_6_3(W(1,10),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,6))
