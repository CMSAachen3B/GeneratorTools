...
C     
C     Process: c~ d~ > x0 g c~ d~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,6),W(1,1),GC_75,MDL_MW,MDL_WW,W(1,8))
      CALL FFV3_3(W(1,7),W(1,2),GC_109,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_3(W(1,5),W(1,2),GC_109,MDL_MW,MDL_WW,W(1,7))
      CALL FFV3_3(W(1,6),W(1,10),GC_75,MDL_MW,MDL_WW,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,7),W(1,11),W(1,3),GC_99,AMP(3))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV3_3(W(1,5),W(1,11),GC_109,MDL_MW,MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL VVS4_0(W(1,10),W(1,8),W(1,3),GC_99,AMP(6))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV3_3(W(1,10),W(1,1),GC_75,MDL_MW,MDL_WW,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL VVS4_0(W(1,7),W(1,6),W(1,3),GC_99,AMP(8))
      JAMP(1)=-AMP(5)-AMP(7)
      JAMP(2)=+AMP(1)+AMP(6)
      JAMP(3)=+AMP(3)+AMP(8)
      JAMP(4)=-AMP(2)-AMP(4)
