...
C     
C     Process: d d~ > x0 g s s~ QCD<=1 QED<=99 QNP=0 @1
C     Process: s s~ > x0 g d d~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_4_3(W(1,6),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,8))
      CALL FFV3_4_3(W(1,6),W(1,7),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,8),W(1,2),W(1,3),GC_100,AMP(3))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,2))
      CALL FFV3_4_3(W(1,2),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,6))
