...
C     
C     Process: g c~ > x0 s u~ d~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_3(W(1,5),W(1,10),GC_108,MDL_MW,MDL_WW,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,4),W(1,8),W(1,3),GC_99,AMP(3))
      CALL FFV1_2(W(1,6),W(1,1),GC_7,ZERO,ZERO,W(1,4))
      CALL FFV3_3(W(1,4),W(1,2),GC_75,MDL_MW,MDL_WW,W(1,6))
