...
C     
C     Process: g u > x0 u b b~ QCD<=1 QED<=99 QNP=0 @1
C     Process: g c > x0 c b b~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,2),W(1,10),GC_2,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,8),W(1,11),GC_1,AMP(6))
      CALL FFV3_6_3(W(1,2),W(1,10),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,12))
