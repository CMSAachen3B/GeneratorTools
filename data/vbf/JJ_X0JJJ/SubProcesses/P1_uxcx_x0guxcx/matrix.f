...
C     
C     Process: u~ c~ > x0 g u~ c~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_6_3(W(1,7),W(1,1),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,8),W(1,9),W(1,3),GC_100,AMP(1))
      CALL FFV1_1(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,9))
      CALL FFV3_6_3(W(1,5),W(1,9),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,8),W(1,7),W(1,3),GC_100,AMP(2))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,7))
      CALL FFV3_6_3(W(1,5),W(1,1),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,8))
      CALL FFV3_6_3(W(1,6),W(1,7),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,8),W(1,5),W(1,3),GC_100,AMP(3))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,5))
      CALL FFV3_6_3(W(1,5),W(1,2),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS4_0(W(1,8),W(1,6),W(1,3),GC_100,AMP(4))
      JAMP(1)=-AMP(3)-AMP(4)
      JAMP(2)=-AMP(1)-AMP(2)
