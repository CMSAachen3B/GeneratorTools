...
C     
C     Process: g c > x0 c s s~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,6),W(1,4),GC_76,MDL_MW,MDL_WW,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV3_3(W(1,2),W(1,5),GC_110,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV3_3(W(1,2),W(1,11),GC_110,MDL_MW,MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV3_3(W(1,10),W(1,4),GC_76,MDL_MW,MDL_WW,W(1,6))
