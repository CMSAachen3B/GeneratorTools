...
C     
C     Process: g s > x0 c s c~ QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_3(W(1,2),W(1,4),GC_76,MDL_MW,MDL_WW,W(1,8))
      CALL FFV3_3(W(1,7),W(1,5),GC_110,MDL_MW,MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,9),W(1,8),W(1,3),GC_99,AMP(1))
      CALL FFV3_4_3(W(1,2),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV3_4_3(W(1,10),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL VVS4_0(W(1,9),W(1,2),W(1,3),GC_100,AMP(7))
      CALL FFV3_3(W(1,10),W(1,4),GC_76,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 8
      CALL VVS4_0(W(1,7),W(1,2),W(1,3),GC_99,AMP(8))
      JAMP(1)=-AMP(3)-AMP(8)
      JAMP(2)=+AMP(2)+AMP(4)
      JAMP(3)=+AMP(5)+AMP(7)
      JAMP(4)=-AMP(1)-AMP(6)
