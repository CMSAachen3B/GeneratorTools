...
C     
C     Process: u~ b > x0 g u~ b QCD<=1 QED<=99 QNP=0 @1
C     Process: c~ b > x0 g c~ b QCD<=1 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV3_6_3(W(1,7),W(1,1),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,5),W(1,10),GC_2,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,8),W(1,11),GC_1,AMP(6))
      CALL FFV3_6_3(W(1,5),W(1,10),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,12))
