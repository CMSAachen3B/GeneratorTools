...
C     
C     Process: d d~ > x0 b b~ QCD=0 QED<=99 QNP=0 @1
C     Process: s s~ > x0 b b~ QCD=0 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 4
      CALL FFV3_4_0(W(1,7),W(1,4),W(1,8),GC_77,GC_89,AMP(4))
