...
C     
C     Process: d d~ > x0 d d~ QCD=0 QED<=99 QNP=0 @1
C     Process: s s~ > x0 s s~ QCD=0 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_4_3(W(1,1),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,6))
      CALL FFV3_4_3(W(1,5),W(1,4),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,6),W(1,7),W(1,3),GC_100,AMP(1))
      CALL FFV3_4_3(W(1,1),W(1,4),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,7))
      CALL FFV3_4_3(W(1,5),W(1,2),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,4))
