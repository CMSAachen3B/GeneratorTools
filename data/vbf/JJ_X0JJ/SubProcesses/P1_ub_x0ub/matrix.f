...
C     
C     Process: u b > x0 u b QCD=0 QED<=99 QNP=0 @1
C     Process: c b > x0 c b QCD=0 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,6))
      CALL FFS1_2_1(W(1,5),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,7),W(1,6),GC_1,AMP(1))
      CALL FFV3_6_3(W(1,1),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV3_4_0(W(1,2),W(1,7),W(1,8),GC_77,GC_89,AMP(2))
      CALL FFS1_2_2(W(1,2),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,5),W(1,6),GC_1,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV3_4_0(W(1,7),W(1,5),W(1,8),GC_77,GC_89,AMP(4))
      CALL FFV3_4_3(W(1,2),W(1,5),GC_77,GC_89,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL VVS4_0(W(1,8),W(1,7),W(1,3),GC_100,AMP(5))
