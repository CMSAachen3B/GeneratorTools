...
C     
C     Process: u u~ > x0 c c~ QCD=0 QED<=99 QNP=0 @1
C     Process: c c~ > x0 u u~ QCD=0 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_6_3(W(1,5),W(1,4),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,6),W(1,2),W(1,3),GC_100,AMP(1))
      JAMP(1)=-AMP(1)
