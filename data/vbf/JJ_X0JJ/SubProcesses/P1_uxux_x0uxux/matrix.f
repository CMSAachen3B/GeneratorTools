...
C     
C     Process: u~ u~ > x0 u~ u~ QCD=0 QED<=99 QNP=0 @1
C     Process: c~ c~ > x0 c~ c~ QCD=0 QED<=99 QNP=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV3_6_3(W(1,4),W(1,1),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,6))
      CALL FFV3_6_3(W(1,5),W(1,2),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,6),W(1,7),W(1,3),GC_100,AMP(1))
      CALL FFV3_6_3(W(1,4),W(1,2),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,7))
      CALL FFV3_6_3(W(1,5),W(1,1),GC_78,GC_89,MDL_MZ,MDL_WZ,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL VVS4_0(W(1,7),W(1,4),W(1,3),GC_100,AMP(2))
      JAMP(1)=-AMP(1)
      JAMP(2)=+AMP(2)
