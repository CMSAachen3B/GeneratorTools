...
C     
C     Process: u u~ > x0 c c~ QNP<=2 WEIGHTED<=4 @1
C     Process: u u~ > x0 d d~ QNP<=2 WEIGHTED<=4 @1
C     Process: u u~ > x0 s s~ QNP<=2 WEIGHTED<=4 @1
C     Process: c c~ > x0 u u~ QNP<=2 WEIGHTED<=4 @1
C     Process: c c~ > x0 d d~ QNP<=2 WEIGHTED<=4 @1
C     Process: c c~ > x0 s s~ QNP<=2 WEIGHTED<=4 @1
C     Process: d d~ > x0 u u~ QNP<=2 WEIGHTED<=4 @1
C     Process: d d~ > x0 c c~ QNP<=2 WEIGHTED<=4 @1
C     Process: d d~ > x0 s s~ QNP<=2 WEIGHTED<=4 @1
C     Process: s s~ > x0 u u~ QNP<=2 WEIGHTED<=4 @1
C     Process: s s~ > x0 c c~ QNP<=2 WEIGHTED<=4 @1
C     Process: s s~ > x0 d d~ QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVS2_6_0(W(1,6),W(1,2),W(1,3),GC_64,GC_10,AMP(1))
