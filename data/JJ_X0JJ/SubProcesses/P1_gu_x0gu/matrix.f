...
C     
C     Process: g u > x0 g u QNP<=2 WEIGHTED<=4 @1
C     Process: g c > x0 g c QNP<=2 WEIGHTED<=4 @1
C     Process: g d > x0 g d QNP<=2 WEIGHTED<=4 @1
C     Process: g s > x0 g s QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,8),W(1,6),GC_7,AMP(2))
      CALL FFV1_2(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,5),W(1,6),GC_7,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVV8_0(W(1,6),W(1,4),W(1,7),GC_6,AMP(4))
      CALL FFV1_1(W(1,5),W(1,1),GC_7,ZERO,ZERO,W(1,6))
      CALL VVS2_6P0_1(W(1,4),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,6),W(1,8),GC_7,AMP(5))
      CALL FFV1_2(W(1,2),W(1,1),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,5),W(1,8),GC_7,AMP(6))
