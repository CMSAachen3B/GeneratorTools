...
C     
C     Process: g u > x0 u QNP<=2 WEIGHTED<=3 @1
C     Process: g c > x0 c QNP<=2 WEIGHTED<=3 @1
C     Process: g d > x0 d QNP<=2 WEIGHTED<=3 @1
C     Process: g s > x0 s QNP<=2 WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,4),W(1,5),GC_7,AMP(1))
      JAMP(1)=+AMP(1)
