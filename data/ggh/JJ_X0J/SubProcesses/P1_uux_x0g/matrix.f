...
C     
C     Process: u u~ > x0 g QNP<=2 WEIGHTED<=3 @1
C     Process: c c~ > x0 g QNP<=2 WEIGHTED<=3 @1
C     Process: d d~ > x0 g QNP<=2 WEIGHTED<=3 @1
C     Process: s s~ > x0 g QNP<=2 WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,1),W(1,2),W(1,5),GC_7,AMP(1))
      JAMP(1)=+AMP(1)
