...
C     
C     Process: b b~ > x0 g QNP<=2 WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFS1_2_0(W(1,5),W(1,2),W(1,3),GC_102,GC_101,AMP(1))
      CALL VVS2_6P0_1(W(1,4),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,2),W(1,5),GC_7,AMP(2))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,MDL_MB,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS1_2_0(W(1,1),W(1,5),W(1,3),GC_102,GC_101,AMP(3))
