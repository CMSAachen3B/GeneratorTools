...
C     
C     Process: u~ u~ > x0 u~ u~ QNP<=2 WEIGHTED<=4 @1
C     Process: c~ c~ > x0 c~ c~ QNP<=2 WEIGHTED<=4 @1
C     Process: d~ d~ > x0 d~ d~ QNP<=2 WEIGHTED<=4 @1
C     Process: s~ s~ > x0 s~ s~ QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,4),W(1,2),GC_7,ZERO,ZERO,W(1,7))
      CALL FFV1P0_3(W(1,5),W(1,1),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL VVS2_6_0(W(1,7),W(1,4),W(1,3),GC_64,GC_10,AMP(2))
