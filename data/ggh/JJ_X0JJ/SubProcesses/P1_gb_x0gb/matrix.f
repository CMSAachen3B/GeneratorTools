...
C     
C     Process: g b > x0 g b QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFS1_2_1(W(1,5),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,7),W(1,6),GC_7,AMP(1))
      CALL FFS1_2_2(W(1,2),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,5),W(1,6),GC_7,AMP(2))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_7,MDL_MB,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,10),W(1,6),GC_7,AMP(4))
      CALL FFV1_2(W(1,2),W(1,4),GC_7,MDL_MB,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,5),W(1,6),GC_7,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV8_0(W(1,6),W(1,4),W(1,9),GC_6,AMP(6))
      CALL FFV1_1(W(1,5),W(1,1),GC_7,MDL_MB,ZERO,W(1,6))
      CALL VVS2_6P0_1(W(1,4),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,6),W(1,12),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,11),W(1,6),W(1,3),GC_102,GC_101,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,8),W(1,6),W(1,4),GC_7,AMP(9))
      CALL FFV1_2(W(1,2),W(1,1),GC_7,MDL_MB,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,5),W(1,12),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFS1_2_0(W(1,6),W(1,10),W(1,3),GC_102,GC_101,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,7),W(1,4),GC_7,AMP(12))
...
C     Amplitude(s) for diagram number 16
      CALL FFS1_2_0(W(1,2),W(1,5),W(1,11),GC_102,GC_101,AMP(16))
      CALL VVVS1_2P0_1(W(1,1),W(1,4),W(1,3),GC_65,GC_11,ZERO,ZERO,W(1
     $ ,11))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,5),W(1,11),GC_7,AMP(17))
