...
C     
C     Process: b b~ > x0 b b~ QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,4),W(1,7),GC_7,AMP(1))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_7,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,6))
      CALL FFS1_2_2(W(1,5),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,4),W(1,6),GC_7,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS2_6_0(W(1,6),W(1,8),W(1,3),GC_64,GC_10,AMP(4))
      CALL FFS1_2_1(W(1,4),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,5),W(1,10),W(1,6),GC_7,AMP(5))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,9),W(1,2),W(1,6),GC_7,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVS2_6_0(W(1,6),W(1,7),W(1,3),GC_64,GC_10,AMP(7))
      CALL FFS1_2_1(W(1,2),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,9),W(1,6),GC_7,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,1),W(1,10),W(1,7),GC_7,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,1),W(1,9),W(1,8),GC_7,AMP(10))
      JAMP(1)=+1D0/2D0*(+AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)+1D0/3D0
     $ *AMP(4)+1D0/3D0*AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(9)+1D0/3D0
     $ *AMP(10))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)
