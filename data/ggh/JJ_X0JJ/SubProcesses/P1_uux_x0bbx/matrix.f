...
C     
C     Process: u u~ > x0 b b~ QNP<=2 WEIGHTED<=4 @1
C     Process: c c~ > x0 b b~ QNP<=2 WEIGHTED<=4 @1
C     Process: d d~ > x0 b b~ QNP<=2 WEIGHTED<=4 @1
C     Process: s s~ > x0 b b~ QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFS1_2_1(W(1,4),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,2),W(1,6),GC_7,AMP(1))
      CALL FFS1_2_2(W(1,5),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,4),W(1,6),GC_7,AMP(2))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL VVS2_6_0(W(1,6),W(1,2),W(1,3),GC_64,GC_10,AMP(3))
