...
C     
C     Process: u c~ > x0 u c~ QNP<=2 WEIGHTED<=4 @1
C     Process: u d~ > x0 u d~ QNP<=2 WEIGHTED<=4 @1
C     Process: u s~ > x0 u s~ QNP<=2 WEIGHTED<=4 @1
C     Process: c u~ > x0 c u~ QNP<=2 WEIGHTED<=4 @1
C     Process: c d~ > x0 c d~ QNP<=2 WEIGHTED<=4 @1
C     Process: c s~ > x0 c s~ QNP<=2 WEIGHTED<=4 @1
C     Process: d u~ > x0 d u~ QNP<=2 WEIGHTED<=4 @1
C     Process: d c~ > x0 d c~ QNP<=2 WEIGHTED<=4 @1
C     Process: d s~ > x0 d s~ QNP<=2 WEIGHTED<=4 @1
C     Process: s u~ > x0 s u~ QNP<=2 WEIGHTED<=4 @1
C     Process: s c~ > x0 s c~ QNP<=2 WEIGHTED<=4 @1
C     Process: s d~ > x0 s d~ QNP<=2 WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVS2_6_0(W(1,6),W(1,4),W(1,3),GC_64,GC_10,AMP(1))
