...
C     
C     Process: b b~ > x0 g u u~ QNP<=2 WEIGHTED<=5 @1
C     Process: b b~ > x0 g c c~ QNP<=2 WEIGHTED<=5 @1
C     Process: b b~ > x0 g d d~ QNP<=2 WEIGHTED<=5 @1
C     Process: b b~ > x0 g s s~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,12),W(1,11),GC_7,AMP(4))
      CALL FFV1_2(W(1,1),W(1,9),GC_7,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,2),W(1,11),GC_7,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV8_0(W(1,9),W(1,11),W(1,10),GC_6,AMP(6))
      CALL FFV1_2(W(1,6),W(1,9),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,5),W(1,10),GC_7,AMP(7))
      CALL FFV1_1(W(1,5),W(1,9),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,6),W(1,12),W(1,10),GC_7,AMP(8))
      CALL FFV1_1(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,6),W(1,12),GC_7,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,1),W(1,8),W(1,5),GC_7,AMP(9))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,12),W(1,11),GC_7,AMP(12))
      CALL FFV1P0_3(W(1,1),W(1,5),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL VVS2_6_0(W(1,11),W(1,12),W(1,3),GC_64,GC_10,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,5),W(1,11),GC_7,AMP(14))
      CALL FFV1_2(W(1,1),W(1,4),GC_7,MDL_MB,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,1),W(1,8),W(1,5),GC_7,AMP(18))
      CALL FFV1_1(W(1,8),W(1,4),GC_7,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,1),W(1,12),W(1,11),GC_7,AMP(19))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFS1_2_3(W(1,1),W(1,2),GC_102,GC_101,MDL_MX0,MDL_WX0,W(1,12)
     $ )
...
C     Amplitude(s) for diagram number 25
     ...
     $ -AMP(21)-IMAG1*AMP(23)-IMAG1*AMP(24)+IMAG1*AMP(25))
      JAMP(3)=+1D0/2D0*(+1D0/3D0*AMP(4)+1D0/3D0*AMP(5)+1D0/3D0*AMP(12)
     $ +1D0/3D0*AMP(13)+1D0/3D0*AMP(14)+1D0/3D0*AMP(15)+1D0/3D0*AMP(16)
     $ +1D0/3D0*AMP(17)+1D0/3D0*AMP(19)+1D0/3D0*AMP(21))
      JAMP(4)=+1D0/2D0*(-AMP(1)-AMP(2)-AMP(3)-AMP(4)+IMAG1*AMP(6)
