...
C     
C     Process: u c~ > x0 g u c~ QNP<=2 WEIGHTED<=5 @1
C     Process: u d~ > x0 g u d~ QNP<=2 WEIGHTED<=5 @1
C     Process: u s~ > x0 g u s~ QNP<=2 WEIGHTED<=5 @1
C     Process: c u~ > x0 g c u~ QNP<=2 WEIGHTED<=5 @1
C     Process: c d~ > x0 g c d~ QNP<=2 WEIGHTED<=5 @1
C     Process: c s~ > x0 g c s~ QNP<=2 WEIGHTED<=5 @1
C     Process: d u~ > x0 g d u~ QNP<=2 WEIGHTED<=5 @1
C     Process: d c~ > x0 g d c~ QNP<=2 WEIGHTED<=5 @1
C     Process: d s~ > x0 g d s~ QNP<=2 WEIGHTED<=5 @1
C     Process: s u~ > x0 g s u~ QNP<=2 WEIGHTED<=5 @1
C     Process: s c~ > x0 g s c~ QNP<=2 WEIGHTED<=5 @1
C     Process: s d~ > x0 g s d~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,1),W(1,10),GC_7,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL VVS2_6_0(W(1,8),W(1,5),W(1,3),GC_64,GC_10,AMP(7))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,10),W(1,2),GC_7,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 12
      ...
      JAMP(1)=+1D0/2D0*(+AMP(3)+IMAG1*AMP(4)+AMP(6)+AMP(7)+AMP(9)
     $ +IMAG1*AMP(10)+IMAG1*AMP(11)-IMAG1*AMP(12))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)
     $ -1D0/3D0*AMP(7))
