...
C     
C     Process: g u~ > x0 c u~ c~ QNP<=2 WEIGHTED<=5 @1
C     Process: g u~ > x0 d u~ d~ QNP<=2 WEIGHTED<=5 @1
C     Process: g u~ > x0 s u~ s~ QNP<=2 WEIGHTED<=5 @1
C     Process: g c~ > x0 u c~ u~ QNP<=2 WEIGHTED<=5 @1
C     Process: g c~ > x0 d c~ d~ QNP<=2 WEIGHTED<=5 @1
C     Process: g c~ > x0 s c~ s~ QNP<=2 WEIGHTED<=5 @1
C     Process: g d~ > x0 u d~ u~ QNP<=2 WEIGHTED<=5 @1
C     Process: g d~ > x0 c d~ c~ QNP<=2 WEIGHTED<=5 @1
C     Process: g d~ > x0 s d~ s~ QNP<=2 WEIGHTED<=5 @1
C     Process: g s~ > x0 u s~ u~ QNP<=2 WEIGHTED<=5 @1
C     Process: g s~ > x0 c s~ c~ QNP<=2 WEIGHTED<=5 @1
C     Process: g s~ > x0 d s~ d~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,10),W(1,4),W(1,7),GC_7,AMP(3))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,5),W(1,10),GC_7,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL VVS2_6_0(W(1,8),W(1,2),W(1,3),GC_64,GC_10,AMP(7))
      CALL FFV1_1(W(1,4),W(1,1),GC_7,ZERO,ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,10),W(1,4),GC_7,ZERO,ZERO,W(1,6))
