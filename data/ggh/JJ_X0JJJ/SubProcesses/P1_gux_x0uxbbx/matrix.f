...
C     
C     Process: g u~ > x0 u~ b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: g c~ > x0 c~ b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: g d~ > x0 d~ b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: g s~ > x0 s~ b b~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1_2(W(1,4),W(1,1),GC_7,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1P0_3(W(1,4),W(1,2),GC_7,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV1_1(W(1,5),W(1,1),GC_7,MDL_MB,ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV1_2(W(1,6),W(1,1),GC_7,MDL_MB,ZERO,W(1,2))
