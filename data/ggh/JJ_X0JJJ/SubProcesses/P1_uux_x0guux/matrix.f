...
C     
C     Process: u u~ > x0 g u u~ QNP<=2 WEIGHTED<=5 @1
C     Process: c c~ > x0 g c c~ QNP<=2 WEIGHTED<=5 @1
C     Process: d d~ > x0 g d d~ QNP<=2 WEIGHTED<=5 @1
C     Process: s s~ > x0 g s s~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS2_6_0(W(1,9),W(1,10),W(1,3),GC_64,GC_10,AMP(2))
      CALL VVS2_6P0_1(W(1,4),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,7))
      CALL FFV1_1(W(1,5),W(1,10),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,11),W(1,7),GC_7,AMP(3))
      CALL FFV1_2(W(1,6),W(1,10),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,5),W(1,7),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV8_0(W(1,10),W(1,7),W(1,9),GC_6,AMP(5))
      CALL FFV1P0_3(W(1,1),W(1,5),GC_7,ZERO,ZERO,W(1,13))
      CALL FFV1_1(W(1,2),W(1,10),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,14),W(1,13),GC_7,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,2),W(1,13),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVV8_0(W(1,10),W(1,13),W(1,8),GC_6,AMP(8))
      CALL FFV1_2(W(1,1),W(1,10),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,5),W(1,8),GC_7,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,1),W(1,11),W(1,8),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,12),W(1,2),W(1,9),GC_7,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,14),W(1,9),GC_7,AMP(12))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,6),W(1,14),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL VVS2_6_0(W(1,13),W(1,12),W(1,3),GC_64,GC_10,AMP(13))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 14
      CALL VVS2_6_0(W(1,9),W(1,12),W(1,3),GC_64,GC_10,AMP(14))
      CALL FFV1_1(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,6),W(1,12),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 15
      CALL VVS2_6_0(W(1,7),W(1,14),W(1,3),GC_64,GC_10,AMP(15))
      CALL FFV1P0_3(W(1,1),W(1,12),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 16
      CALL VVS2_6_0(W(1,8),W(1,14),W(1,3),GC_64,GC_10,AMP(16))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,14),W(1,5),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 17
      CALL VVS2_6_0(W(1,7),W(1,6),W(1,3),GC_64,GC_10,AMP(17))
      CALL FFV1P0_3(W(1,14),W(1,2),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 18
      CALL VVS2_6_0(W(1,13),W(1,6),W(1,3),GC_64,GC_10,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVVS1_2_0(W(1,4),W(1,7),W(1,9),W(1,3),GC_65,GC_11,AMP(19))
      CALL VVV8P0_1(W(1,4),W(1,7),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 20
      CALL VVS2_6_0(W(1,9),W(1,6),W(1,3),GC_64,GC_10,AMP(20))
      CALL VVV8P0_1(W(1,4),W(1,9),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 21
      CALL VVS2_6_0(W(1,7),W(1,6),W(1,3),GC_64,GC_10,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL VVVS1_2_0(W(1,4),W(1,13),W(1,8),W(1,3),GC_65,GC_11,AMP(22))
      CALL VVV8P0_1(W(1,4),W(1,13),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 23
      CALL VVS2_6_0(W(1,8),W(1,6),W(1,3),GC_64,GC_10,AMP(23))
      CALL VVV8P0_1(W(1,4),W(1,8),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 24
      CALL VVS2_6_0(W(1,13),W(1,6),W(1,3),GC_64,GC_10,AMP(24))
      JAMP(1)=+1D0/2D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)+AMP(7)+IMAG1
     $ *AMP(8)+AMP(10)+1D0/3D0*AMP(15)+AMP(16)+1D0/3D0*AMP(17)+AMP(18)
     $ +IMAG1*AMP(22)+IMAG1*AMP(23)-IMAG1*AMP(24))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-AMP(2)-AMP(3)+IMAG1*AMP(5)-1D0
     $ /3D0*AMP(9)-1D0/3D0*AMP(10)-AMP(11)-AMP(15)-1D0/3D0*AMP(16)
     $ +IMAG1*AMP(19)+IMAG1*AMP(20)-IMAG1*AMP(21))
      JAMP(3)=+1D0/2D0*(+AMP(1)+1D0/3D0*AMP(2)+AMP(6)-IMAG1*AMP(8)
     $ +AMP(9)+1D0/3D0*AMP(11)+1D0/3D0*AMP(12)+AMP(13)+1D0/3D0*AMP(14)
     $ -IMAG1*AMP(22)-IMAG1*AMP(23)+IMAG1*AMP(24))
      JAMP(4)=+1D0/2D0*(-AMP(4)-IMAG1*AMP(5)-1D0/3D0*AMP(6)-1D0/3D0
     $ *AMP(7)-AMP(12)-1D0/3D0*AMP(13)-AMP(14)-AMP(17)-1D0/3D0*AMP(18)
     $ -IMAG1*AMP(19)-IMAG1*AMP(20)+IMAG1*AMP(21))
