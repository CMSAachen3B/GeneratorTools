...
C     
C     Process: g u~ > x0 u u~ u~ QNP<=2 WEIGHTED<=5 @1
C     Process: g c~ > x0 c c~ c~ QNP<=2 WEIGHTED<=5 @1
C     Process: g d~ > x0 d d~ d~ QNP<=2 WEIGHTED<=5 @1
C     Process: g s~ > x0 s s~ s~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVS2_6_0(W(1,9),W(1,10),W(1,3),GC_64,GC_10,AMP(2))
      CALL VVS2_6P0_1(W(1,1),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_7,ZERO,ZERO,W(1,7))
      CALL FFV1_1(W(1,4),W(1,10),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,11),W(1,7),GC_7,AMP(3))
      CALL FFV1_2(W(1,6),W(1,10),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,4),W(1,7),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV8_0(W(1,10),W(1,7),W(1,9),GC_6,AMP(5))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,4),W(1,8),GC_7,AMP(9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_1(W(1,2),W(1,1),GC_7,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,6),W(1,1),GC_7,ZERO,ZERO,W(1,14))
      CALL FFV1P0_3(W(1,14),W(1,4),GC_7,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 19
      CALL VVVS1_2_0(W(1,1),W(1,7),W(1,9),W(1,3),GC_65,GC_11,AMP(19))
      CALL VVV8P0_1(W(1,1),W(1,7),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 20
      CALL VVS2_6_0(W(1,9),W(1,6),W(1,3),GC_64,GC_10,AMP(20))
      CALL VVV8P0_1(W(1,1),W(1,9),GC_6,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 21
      CALL VVS2_6_0(W(1,7),W(1,6),W(1,3),GC_64,GC_10,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL VVVS1_2_0(W(1,1),W(1,13),W(1,8),W(1,3),GC_65,GC_11,AMP(22))
      CALL VVV8P0_1(W(1,1),W(1,13),GC_6,ZERO,ZERO,W(1,6))
