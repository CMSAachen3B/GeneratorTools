...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_7,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 58
      ...
      CALL FFS1_2_3(W(1,1),W(1,2),GC_102,GC_101,MDL_MX0,MDL_WX0,W(1,19)
     $ )
...
C     Amplitude(s) for diagram number 67
      ...
      CALL FFS1_2_3(W(1,1),W(1,5),GC_102,GC_101,MDL_MX0,MDL_WX0,W(1,12)
     $ )
...
C     Amplitude(s) for diagram number 76
     ...
     $ -1D0/6D0*AMP(75)
      JAMP(3)=+1D0/2D0*AMP(1)+1D0/6D0*AMP(2)+1D0/6D0*AMP(3)+1D0/2D0
     ...
     $ *IMAG1*AMP(76)
      JAMP(4)=-1D0/2D0*AMP(12)-1D0/2D0*IMAG1*AMP(13)-1D0/6D0*AMP(14)
