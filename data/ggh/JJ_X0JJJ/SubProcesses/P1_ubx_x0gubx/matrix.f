...
C     Amplitude(s) for diagram number 25
      ...
      JAMP(1)=+1D0/2D0*(+AMP(5)+IMAG1*AMP(6)+AMP(8)+AMP(9)+AMP(10)
     $ +AMP(11)+AMP(15)+AMP(16)+AMP(17)+IMAG1*AMP(18)+IMAG1*AMP(20)
     $ +AMP(21)+IMAG1*AMP(23)+IMAG1*AMP(24)-IMAG1*AMP(25))
      JAMP(2)=-1D0/6D0*AMP(1)-1D0/6D0*AMP(2)-1D0/6D0*AMP(3)-1D0/6D0
