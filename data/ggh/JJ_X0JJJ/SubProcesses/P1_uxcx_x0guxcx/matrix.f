...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_2(W(1,5),W(1,9),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,1),W(1,8),GC_7,AMP(5))
      CALL FFV1_1(W(1,1),W(1,9),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,10),W(1,8),GC_7,AMP(6))
      CALL FFV1_1(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,5),W(1,10),GC_7,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 7
      CALL VVS2_6_0(W(1,8),W(1,1),W(1,3),GC_64,GC_10,AMP(7))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,1))
      CALL FFV1P0_3(W(1,6),W(1,1),GC_7,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 12
     ...
     $ +IMAG1*AMP(10)+IMAG1*AMP(11)-IMAG1*AMP(12))
      JAMP(3)=+1D0/2D0*(-AMP(3)-IMAG1*AMP(4)-AMP(6)-AMP(7)-AMP(9)
     $ -IMAG1*AMP(10)-IMAG1*AMP(11)+IMAG1*AMP(12))
      JAMP(4)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)
     $ +1D0/3D0*AMP(7))
