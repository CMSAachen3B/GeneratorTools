...
C     
C     Process: u u~ > x0 g b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: c c~ > x0 g b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: d d~ > x0 g b b~ QNP<=2 WEIGHTED<=5 @1
C     Process: s s~ > x0 g b b~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_7,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,8),W(1,9),GC_7,AMP(1))
      CALL FFS1_2_2(W(1,6),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_7,AMP(2))
      CALL FFV1P0_3(W(1,6),W(1,5),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,5),W(1,9),GC_7,MDL_MB,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,2),W(1,10),GC_7,AMP(7))
      CALL FFV1_1(W(1,2),W(1,9),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,12),W(1,10),GC_7,AMP(8))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,1),W(1,12),GC_7,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,8),W(1,2),GC_7,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL VVS2_6_0(W(1,10),W(1,2),W(1,3),GC_64,GC_10,AMP(11))
      CALL FFV1_1(W(1,5),W(1,4),GC_7,MDL_MB,ZERO,W(1,2))
      CALL FFS1_2_1(W(1,2),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,12),W(1,11),GC_7,AMP(12))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL VVS2_6_0(W(1,11),W(1,12),W(1,3),GC_64,GC_10,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,7),W(1,2),W(1,11),GC_7,AMP(14))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,MDL_MB,ZERO,W(1,2))
      CALL FFS1_2_2(W(1,2),W(1,3),GC_102,GC_101,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,5),W(1,11),GC_7,AMP(15))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL VVS2_6_0(W(1,11),W(1,12),W(1,3),GC_64,GC_10,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,8),W(1,11),GC_7,AMP(17))
      CALL VVV8P0_1(W(1,4),W(1,11),GC_6,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,6),W(1,8),W(1,2),GC_7,AMP(18))
      CALL FFV1_1(W(1,8),W(1,4),GC_7,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,12),W(1,11),GC_7,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,5),W(1,2),GC_7,AMP(20))
      CALL FFV1_2(W(1,7),W(1,4),GC_7,MDL_MB,ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,12),W(1,5),W(1,11),GC_7,AMP(21))
...
C     Amplitude(s) for diagram number 24
      CALL VVS2_6_0(W(1,10),W(1,2),W(1,3),GC_64,GC_10,AMP(24))
      CALL VVV8P0_1(W(1,4),W(1,10),GC_6,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 25
      CALL VVS2_6_0(W(1,11),W(1,2),W(1,3),GC_64,GC_10,AMP(25))
     ...
     $ *AMP(20)+IMAG1*AMP(23)+IMAG1*AMP(24)-IMAG1*AMP(25))
      JAMP(3)=+1D0/6D0*AMP(1)+1D0/6D0*AMP(2)+1D0/6D0*AMP(3)+1D0/6D0
     $ *AMP(7)+1D0/6D0*AMP(8)+1D0/6D0*AMP(9)+1D0/6D0*AMP(10)+1D0/6D0
     $ *AMP(11)-AMP(22)
      JAMP(4)=+1D0/2D0*(-AMP(5)-IMAG1*AMP(6)-AMP(8)-AMP(9)-AMP(10)
