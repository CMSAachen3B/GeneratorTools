...
C     
      SUBROUTINE VVVSS1_4(V1, V2, V3, S5, COUP, M4, W4,S4)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ * W4))
      S4(3)= DENOM*(-4D0 )* S5(3)*(+CI*(TMP12+TMP13+TMP14))
      END
...
C      4*Epsilon(1,2,3,-1)*P(-1,3)
C     
      SUBROUTINE VVVSS1_2_4(V1, V2, V3, S5, COUP1, COUP2, M4, W4,S4)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
      ...
      COMPLEX*16 V1(*)
      REAL*8 W4
      CALL VVVSS1_4(V1,V2,V3,S5,COUP1,M4,W4,S4)
      CALL VVVSS2_4(V1,V2,V3,S5,COUP2,M4,W4,STMP)
      DO I = 3, 3
        S4(I) = S4(I) + STMP(I)
      ENDDO
      END
