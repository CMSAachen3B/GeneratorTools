...
C     
      SUBROUTINE VVVSS1_0(V1, V2, V3, S4, S5, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ *V2(4)-V3(4)*V2(3)))))))
      TMP13 = (-1D0)*(P2(0)*(V1(4)*(V3(6)*V2(5)-V3(5)*V2(6))+(V1(5)
     $ *(V3(4)*V2(6)-V3(6)*V2(4))+V1(6)*(V3(5)*V2(4)-V3(4)*V2(5))))
     ...
     $ -V3(5)*V2(4))+(V1(4)*(V3(5)*V2(3)-V3(3)*V2(5))+V1(5)*(V3(3)
     $ *V2(4)-V3(4)*V2(3)))))))
      TMP12 = (-1D0)*(P1(0)*(V1(4)*(V3(6)*V2(5)-V3(5)*V2(6))+(V1(5)
     $ *(V3(4)*V2(6)-V3(6)*V2(4))+V1(6)*(V3(5)*V2(4)-V3(4)*V2(5))))
     ...
     $ -V3(5)*V2(4))+(V1(4)*(V3(5)*V2(3)-V3(3)*V2(5))+V1(5)*(V3(3)
     $ *V2(4)-V3(4)*V2(3)))))))
      VERTEX = COUP*4D0 * S4(3)*S5(3)*(+CI*(TMP12+TMP13+TMP14))
      END
...
C      4*Epsilon(1,2,3,-1)*P(-1,3)
C     
      SUBROUTINE VVVSS1_2_0(V1, V2, V3, S4, S5, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 V2(*)
      ...
      COMPLEX*16 V1(*)
      COMPLEX*16 S4(*)
      CALL VVVSS1_0(V1,V2,V3,S4,S5,COUP1,VERTEX)
      CALL VVVSS2_0(V1,V2,V3,S4,S5,COUP2,TMP)
      VERTEX = VERTEX + TMP
      END
