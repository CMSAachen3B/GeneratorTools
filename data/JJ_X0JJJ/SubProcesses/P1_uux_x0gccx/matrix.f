...
C     
C     Process: u u~ > x0 g c c~ QNP<=2 WEIGHTED<=5 @1
C     Process: u u~ > x0 g d d~ QNP<=2 WEIGHTED<=5 @1
C     Process: u u~ > x0 g s s~ QNP<=2 WEIGHTED<=5 @1
C     Process: c c~ > x0 g u u~ QNP<=2 WEIGHTED<=5 @1
C     Process: c c~ > x0 g d d~ QNP<=2 WEIGHTED<=5 @1
C     Process: c c~ > x0 g s s~ QNP<=2 WEIGHTED<=5 @1
C     Process: d d~ > x0 g u u~ QNP<=2 WEIGHTED<=5 @1
C     Process: d d~ > x0 g c c~ QNP<=2 WEIGHTED<=5 @1
C     Process: d d~ > x0 g s s~ QNP<=2 WEIGHTED<=5 @1
C     Process: s s~ > x0 g u u~ QNP<=2 WEIGHTED<=5 @1
C     Process: s s~ > x0 g c c~ QNP<=2 WEIGHTED<=5 @1
C     Process: s s~ > x0 g d d~ QNP<=2 WEIGHTED<=5 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_2(W(1,1),W(1,9),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_7,AMP(5))
      CALL FFV1_1(W(1,2),W(1,9),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,1),W(1,10),W(1,8),GC_7,AMP(6))
      CALL FFV1_1(W(1,2),W(1,4),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_7,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL VVS2_6_0(W(1,8),W(1,2),W(1,3),GC_64,GC_10,AMP(7))
      CALL FFV1_1(W(1,5),W(1,4),GC_7,ZERO,ZERO,W(1,2))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL VVS2_6_0(W(1,7),W(1,10),W(1,3),GC_64,GC_10,AMP(8))
      CALL FFV1_2(W(1,6),W(1,4),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,10),W(1,5),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL VVS2_6_0(W(1,7),W(1,6),W(1,3),GC_64,GC_10,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVVS1_2_0(W(1,4),W(1,7),W(1,8),W(1,3),GC_65,GC_11,AMP(10))
...
C     Amplitude(s) for diagram number 12
      ...
      JAMP(1)=+1D0/2D0*(+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)+1D0/3D0*AMP(8)
     $ +1D0/3D0*AMP(9))
      JAMP(2)=+1D0/2D0*(-AMP(1)-AMP(2)+IMAG1*AMP(4)-AMP(5)-AMP(8)
     $ +IMAG1*AMP(10)+IMAG1*AMP(11)-IMAG1*AMP(12))
      JAMP(3)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)
     $ +1D0/3D0*AMP(7))
      JAMP(4)=+1D0/2D0*(-AMP(3)-IMAG1*AMP(4)-AMP(6)-AMP(7)-AMP(9)
     $ -IMAG1*AMP(10)-IMAG1*AMP(11)+IMAG1*AMP(12))
